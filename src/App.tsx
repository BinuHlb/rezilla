...
import { Menu, Phone, Mail, MapPin, ChevronRight, Search, ArrowRight, Map } from 'lucide-react';
...
function App() {
  ...
  <div className="container mx-auto px-4">
    <div className="flex justify-between items-center h-20">
      ...
      {/* Column 3: Login/Register and Main Button */}
      <div className="flex items-center space-x-4">
        ...
        <button className="bg-violet-800 text-white px-4 py-2 rounded-full hover:bg-violet-900">Add Listing</button>
      </div>
    </div>
  </div>
  ...
  {mobileMenuOpen && (
    <div className="md:hidden">
      <div className="px-2 pt-2 pb-3 space-y-1">
        ...
        <a href="#" className="block px-3 py-2 text-gray-700">Register</a>
        <button className="w-full bg-violet-800 text-white px-4 py-2 rounded-full hover:bg-blue-700">Main Action</button>
      </div>
    </div>
  )}
</nav>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <Button size="lg" className="bg-violet-800 hover:bg-blue-700">
